...
function profile (req, res) {
	...
	if (method === "DELETE") {
		...
		next = () => {
			if (typeof data.firstname !== "string" || typeof data.lastname !== "string" || typeof data.email !== "string" || !regex.firstname.test(data.firstname) || !regex.lastname.test(data.lastname) || !regex.email.test(data.email)) {
